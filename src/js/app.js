...
app.loader
  ...
  .add("../src/img/slots/johnybravo.png", "../src/img/slots/johnybravo.png")
  .add("../src/img/slots/joker.png", "../src/img/slots/joker.png")
  .add("../src/img/slots/rabbit.png", "../src/img/slots/rabbit.png")
  .add("../src/img/slots/monk.png", "../src/img/slots/monk.png")
  .add("../src/img/slots/merlin.png", "../src/img/slots/merlin.png")
  .add("../src/img/slots/mermaid.png", "../src/img/slots/mermaid.png")
  .add("../src/img/slots/skateboarder.png", "../src/img/slots/skateboarder.png")
  .load(onAssetsLoaded);
...
function onAssetsLoaded() {
  ...
  createArrayofImages();
  function createArrayofImages() {
    let imgArray = new Array();

    imgArray[0] = new Image();
    imgArray[0].src = "../src/img/slots/brain.png";
    imgArray[0].name = "Jackpot";

    imgArray[1] = new Image();
    imgArray[1].src = "../src/img/slots/discotimes.png";
    imgArray[1].name = "Dancing";

    imgArray[2] = new Image();
    imgArray[2].src = "../src/img/slots/grumpyman.png";
    imgArray[2].name = "Hungry";

    imgArray[3] = new Image();
    imgArray[3].src = "../src/img/slots/headball.png";
    imgArray[3].name = "Sporty";

    imgArray[4] = new Image();
    imgArray[4].src = "../src/img/slots/johnybravo.png";
    imgArray[4].name = "Hungry Beach";

    imgArray[5] = new Image();
    imgArray[5].src = "../src/img/slots/joker.png";
    imgArray[5].name = "Historic Dancing";

    imgArray[6] = new Image();
    imgArray[6].src = "../src/img/slots/rabbit.png";
    imgArray[6].name = "Rabbit";

    imgArray[7] = new Image();
    imgArray[7].src = "../src/img/slots/monk.png";
    imgArray[7].name = "Historic";

    imgArray[8] = new Image();
    imgArray[8].src = "../src/img/slots/merlin.png";
    imgArray[8].name = "Historic";

    imgArray[9] = new Image();
    imgArray[9].src = "../src/img/slots/mermaid.png";
    imgArray[9].name = "Beach";

    imgArray[10] = new Image();
    imgArray[10].src = "../src/img/slots/skateboarder.png";
    imgArray[10].name = "Sporty";
